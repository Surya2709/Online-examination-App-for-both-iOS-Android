...
class Second_Year_Page extends StatelessWidget {
  List Subjects=["DISCRETE MATHEMATICS","DPSD","DATA STRUCTURE","OOP","COMMUNICATION ENGINEERING"];
  List SubCode=["MA8351","CS8351","CS8391","CS8392","EC8395"];

  List Subjects_2=["PQT","COMPUTER ARCHITECTURE","DBMS","DAA","OPERATING SYSTEM","SOFTWARE ENGINEERING"];
  List SubCode_2=["MA8402","CS8491","CS8492","CS8451","CS8493","CS8494"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("CSE Second Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
