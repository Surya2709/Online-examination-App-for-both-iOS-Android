...
class Third_Year_Page extends StatelessWidget {
  List Subjects=["ALGEBRA & NUMBER THEORY","COMPUTER NETWORKS","MPMC","TOC","OOAD","GIS"];
  List SubCode=["MA8551","CS8591","EC8691","CS8501","CS8592","OCE552"];

  List Subjects_2=["INTERNET PROGRAMMING","ARTIFICIAL INTELLIGENCE","MOBILE COMPUTING","COMPILER DESIGN","DISTRIBUTED SYSTEM","DWDM"];

  List SubCode_2=["CS8651","CS8691","CS8601","CS8602","CS8603","CS8075"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("CSE Third Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
