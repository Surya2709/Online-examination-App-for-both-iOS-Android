...
class First_Year_Page extends StatelessWidget {
  ...
  List Subjects_2=["TECHNICAL ENGLISH","EM-II","BEEE","PCE","EVS","ENGINEERING MECHANICS"];
  List SubCode_2=["HS8251","MA8251","BE8253","PH8251","GE8291","GE8282"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("MECH First Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
