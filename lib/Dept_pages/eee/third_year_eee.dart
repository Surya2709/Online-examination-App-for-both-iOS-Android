...
class Third_Year_Page extends StatelessWidget {
  List Subjects=["OOP","PSA","DSP","MPMC","POWER ELECTRONICS","SENSORS & TRANSDUCERS"];
  List SubCode=["CS8392","EE8501","EE8591","EE8551","EE8552","OAN551"];

  List Subjects_2=["EMBEDDED SYSTEM","SSD","PROTECTION & SWITCHGEAR","DEA","POWER QUALITY"];
  List SubCode_2=["EE8691","EE8601","EE8602","EE8002","EE8006"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("EEE Third Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
