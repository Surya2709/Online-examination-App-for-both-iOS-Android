...
class First_Year_Page extends StatelessWidget {
  ...
  List Subjects_2=["TRECHNICAL ENGLISH","EM-II","PEE","BCME","CIRCUIT THEORY","EVSE"];
  List SubCode_2=["HS8251","MA8251","PH8253","BE8252","EE8251","GE8291"];
  @override
  Widget build(BuildContext context){
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("EEE First Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
