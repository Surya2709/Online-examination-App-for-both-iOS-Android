...
class Second_Year_Page extends StatelessWidget {
  List Subjects=["TPDE","SURVEYING","SOM-I","FLUID MECHANICS","CONSTRUCTION MATERIALS","ENGINEERING GEOLOGY"];
  List SubCode=["MA8353","CE8351","CE8301","CS8302","CE8391","CE8392"];

  List Subjects_2=["NUMERICAL METHODS","SOIL MECHANICS","CTP","SOM-II","AHE","CONCRETE TECHNOLOGY"];
  List SubCode_2=["MA8491","CE8491","CE8401","CE8402","CE8403","CE8404"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("CIVIL Second Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
