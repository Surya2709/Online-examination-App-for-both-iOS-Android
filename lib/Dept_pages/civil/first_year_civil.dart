...
class First_Year_Page extends StatelessWidget {
  ...
  List Subjects_2=["TECHNICAL ENGLISH","ENGINEERING MATH 2","BEEE","PCE","EVS","ENGINEERING MECHANICS"];

  List SubCode_2=["HS8251","MA8251","BE8251","PH8201","GE8291","GE8292"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("CIVIL First Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
