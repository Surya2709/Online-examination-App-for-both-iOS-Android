...
class Third_Year_Page extends StatelessWidget {
  List Subjects=["DIGITAL COMMUNICATION","COMMUNICATION NETWORK","CPO","DTSP","RES","MEDICAL ELECTRONICS"];
  List SubCode=["EC8501","EC8551","EC8552","EC8553","OR0551","EC8073"];

  List Subjects_2=["POM","TLRFS","WIRELESS COMMUNICATION","MPMC","VLSI DESIGN","TECHNICAL SEMINAR"];

  List SubCode_2=["MG8591","EC8651","EC8652","EC8691","EC8095","EC8611"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("ECE Third Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
