...
class First_Year_Page extends StatelessWidget {
  ...
  List Subjects_2=["TECHNICAL ENGLISH","ENGINEERING MATH-II","PES","BEIE","CIRCUIT ANALYSIS","ELECTRIC DEVICES"];
  List SubCode_2=["HS8251","MA8251","PH8253","BE8254","EC8251","EC8252"];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (
          AppBar(
            title: Text("ECE First Year",style: TextStyle(color: Colors.white),),
            elevation: 0.0,
